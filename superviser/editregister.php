...
mysql_query("update register set did='$ddid',rid='$rrid',aid='$aaid',name='$nam',contactno='$cno',address='$add',email='$eid',username='$unam',password='$pwd',status='$stts' where regid='$id'");
