				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  $regidd=$_SESSION['regid4'];
						  
						  $sql=mysql_query("select * from schedule where regid='$regidd'");
						  ...
						  echo $row1[4];
								...
								<td><a href="details.php?id=<?php echo $coid; ?>">					                     
								<?php 
								$cid=$row[2];
					$sql2=mysql_query("select * from complain where cid='$cid'");
						while($row2=mysql_fetch_array($sql2))
						  {
						  $regid=$row2[1];
			$sql3=mysql_query("select * from register where regid='$regid'");
						  ...
						  ?>
								...
								<td class="center">
									<a class="btn btn-success" href="remainschedule.php?sdlid=<?php echo $id; ?>">
