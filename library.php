...
define("SMTP_UNAME", "miramodi93@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "miramiramira"); //Password for SMTP authentication
