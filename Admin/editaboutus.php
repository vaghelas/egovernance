...
$id=$_REQUEST['id'];
$sql=mysql_query("select * from aboutus where abid='$id'");
...
mysql_query("update aboutus set text1='$t1',text2='$t2' where abid='$id'");

header('location:viewaboutus.php?msg1=edt');
}
?>
